...
sudo apt update
sudo apt upgrade 
sudo apt -y install make cmake git xterm python-pip synaptic swig doxygen gr-osmosdr pkg-config libpulse-dev qt5-default libqt5svg5-dev sudo apt install direwolf libboost-all-dev libqt5widgets5 libqt5gui5 libqt5dbus5 libqt5network5 libqt5core5a pulseaudio-utils pavucontrol gnuradio
